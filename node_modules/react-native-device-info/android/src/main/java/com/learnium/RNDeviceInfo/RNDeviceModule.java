...
public class RNDeviceModule extends ReactContextBaseJavaModule {
  ...
  Map<String, Object> getConstants() {
    ...
    // constants.put("hasDST", TimeZone.getDefault().observesDaylightTime());
    // Returns the amount of time to be added to local standard time to get local wall clock time.
    // constants.put("DSTSaving", TimeZone.getDefault().getDSTSavings());
    // Returns the offset of this time zone from UTC at the specified date.
    // constants.put("UTCDST", TimeZone.getDefault().getOffset(now));
    // Returns the amount of time in milliseconds to add to UTC to get standard time in this time zone.
    constants.put("UTC", TimeZone.getDefault().getRawOffset());
    // Queries if the given date is in Daylight Saving Time in this time zone.
    // constants.put("isDST", TimeZone.getDefault().inDaylightTime(now));
    // Queries if this TimeZone uses Daylight Saving Time.
    constants.put("useDTS", TimeZone.getDefault().useDaylightTime()); // abstract boolean 
